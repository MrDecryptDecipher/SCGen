export interface ContractTypes {
    'PRIVATE LIMITED COMPANY': Record<string, string[]>;
    'LIMITED LIABILITY PARTNERSHIP': Record<string, string[]>;
    'GENERAL PARTNERSHIP': Record<string, string[]>;
    'SOLE PROPRIETORSHIP': Record<string, string[]>;
    'ONE PERSON COMPANY': Record<string, string[]>;
    'GOVERNMENT ENTITY': Record<string, string[]>;
    'INDIVIDUAL': Record<string, string[]>;
}

export interface TemplateTypes {
    'Equity Tokenization': string;
    'Profit Sharing Agreement': string;
    'Supply Chain Management': string;
    'Revenue Sharing Agreement': string;
    [key: string]: string;
}

export const contractMap: ContractTypes = {
...
export const templateMap: TemplateTypes = {
