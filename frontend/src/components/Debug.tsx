...
export const Debug: React.FC = () => {
  ...
  const checkApi = async () => {
    try {
      ...
      const response = await fetch(process.env.REACT_APP_API_URL || 'http://3.111.22.56:3002/api/health');
        ...
        <ExpandableSection title="Environment Info">
          <List component="div" disablePadding>
            ...
            <ListItem sx={{ pl: 4 }}>
              <ListItemText
                primary="API URL"
                secondary={process.env.REACT_APP_API_URL || 'http://3.111.22.56:3002'}
                primaryTypographyProps={{ variant: 'body2', color: 'primary.light' }}
                secondaryTypographyProps={{ variant: 'caption' }}
              />
            </ListItem>
            ...
            <Button
              ...
              onClick={() => {
                console.log("SCGen Debug Info:", {
                  ...
                  api: process.env.REACT_APP_API_URL || 'http://3.111.22.56:3002',
